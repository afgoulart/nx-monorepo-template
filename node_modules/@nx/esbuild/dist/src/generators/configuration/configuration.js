...
function addBuildTarget(tree, options, isTsSolutionSetup) {
    (0, internal_1.addBuildTargetDefaults)(tree, '@nx/esbuild:esbuild', options.buildTarget, [
    ...
    if (isTsSolutionSetup) {
        buildOptions.declarationRootDir = (0, internal_2.getProjectSourceRoot)(project, tree);
    }
    else {
        buildOptions.assets = [];
...
function updatePackageJson(tree, options, isTsSolutionSetup) {
    ...
    if (tree.exists(packageJsonPath)) {
        ...
        packageJson = {
            name: (0, internal_2.getImportPath)(tree, options.project),
            version: '0.0.1',
        };
    }
    if (isTsSolutionSetup) {
